 ...
 * It allows users to add, edit, view locations for each project, and delete projects.
 * 
 * @component
 * @example
 * return (
 *   <ProjectList projects={projectsArray} deleteProject={deleteProjectFunction} />
 * )
 */
 ...
 /**
  * ProjectList component for managing and displaying projects.
  * 
  * @param {Object} props - Component properties.
  * @param {Array} props.projects - Array of project objects to display.
  * @param {Function} props.deleteProject - Function to delete a project.
     ...
     <div className="min-h-screen bg-gray-50">
       <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="py-8">
           ...
           {projects.length === 0 ? (
             <p className="text-lg text-gray-600">No projects found.</p> // Message if no projects are available
           ) : (
                 ...
                 <li key={project.id} className="bg-white shadow-md rounded-lg p-6 border border-gray-200">
                   ...
                   <div className="flex justify-between items-center mt-4">
                     <span className={`text-sm font-medium px-4 py-2 rounded-lg shadow ${project.is_published ? 'bg-green-500 text-white' : 'bg-red-500 text-white'} border border-${project.is_published ? 'green' : 'red'}-300`}>
                       {project.is_published ? 'Published' : 'Not Published'} {/* Displays publication status */}
                     </span>
                     ...
                     <div className="flex space-x-4 items-center">
                       ...
                       <button
                         ...
                         onClick={() => deleteProject(project.id)} // Calls deleteProject function with the project ID
                       >
                         Delete
                       </button>
                     </div>
